...
/*
 *@uthor: rv042687-roshan / rg042938-rajesh
 */
public class ORN_VR_VISITLIST extends Settings{
	...
	{	
		...
		report = UtilityMethods.Instance(VisitListData.testName, browser) ;
		...
		utm.verifyWithScreen(vstDet.titleTxt.getText(),VisitListData.detTitleTxt, VisitListData.testName, imageName)
		...
		/* Step4 */
		test.log(LogStatus.INFO, "Step-4",  "PopUp Should get Closed");
		...
		vstRev.vmBtn.click();
		System.out.println("F1=" +vstPg.futBtn.getText()); 
		System.out.println("f2=" +VisitListData.futTxt); 
		...
		//System.out.println("1=" +vstPg.futHead.getText()); 
		//System.out.println("2=" +VisitListData.prevTxt);
		utm.verify(vstPg.futHead.getText(), VisitListData.futTxt)
		.verify(vstPg.bckBtn.isDisplayed(),  "Back Button")
		.verify(vstPg.verifyEncData(VisitListData.FutEnc4_AttPhy), "Enc4 Future Time - Step-8")
		...
		vstPg.selectEncWith("Jan 1, 2025 6:00 AM");
		utm.verifyWithScreen(vstPg.sidePnl.isEnabled(), "Details Slide Panel", VisitListData.testName, imageName)
		...
		imageName = "NoFutPrev";
		driver.get(VisitListData.URL);
		utm.enterText(patSrch.PatientSearchTextBox,VisitListData.PatientB, test);
		patSrch.selectPatient(VisitListData.PatientB, test);	
		encSelc.selectEncounter(VisitListData.FIN_B, test);
