...
public class ORN_VR_VISITLIST extends Settings{
	...
	{	
		...
		utm.verifyWithScreen(vstPg.titleTxt.getText(), VisitListData.visitLstTxt, VisitListData.testName, imageName)
		...
		utm.verifyWithScreen(vstPg.futHead.getText(), VisitListData.futTxt, VisitListData.testName, imageName)
