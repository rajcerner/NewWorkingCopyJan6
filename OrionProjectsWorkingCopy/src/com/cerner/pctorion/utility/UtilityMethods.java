...
public class UtilityMethods extends Settings 
{
	 ...
	 * 
	 * */
	public UtilityMethods verify(String actual, String expected)
	{
		try{
	 ...
	 * */
	public UtilityMethods verify(Boolean status, String stepDesc)
	{
		try{
	 ...
	 * */
	public UtilityMethods verifyWithScreen(String actual, String expected, String testName, String imageName)
	{
	 ...
	 * #parameter-4 : imageName
	 * */
	public UtilityMethods verifyWithScreen(Boolean status, String stepDesc, String testName, String imageName)
	{
		captureScreenshot(driver, testName, imageName, browser);
		try{		
			Assert.assertTrue(status);
